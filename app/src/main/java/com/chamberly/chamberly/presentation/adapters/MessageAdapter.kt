...
class MessageAdapter(private val uid: String) :
    ...
    inner class QuestionCardViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        val questionContent: TextView = itemView.findViewById(R.id.questionContent)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            VIEW_TYPE_QUESTION -> {
                val itemView = inflater.inflate(R.layout.item_question_card, parent, false)
                QuestionCardViewHolder(itemView)
            }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (holder) {
            ...
            is QuestionCardViewHolder -> {
                holder.questionContent.text = message.game_content
            }
        }
    }
    ...
    override fun getItemViewType(position: Int): Int {
        val message = messages[position]
        return if (message.message_type == "custom" && message.sender_name != "system") {
            VIEW_TYPE_QUESTION
        } else if (
            message.UID == uid
        ){
